...
법정동 코드(LAWD_CD):
  ...
  경기도 화성시 병점구  = 41595
  경기도 화성시 동탄구  = 41597
  (화성시는 2026-02-01부로 4개 구로 분구 — 기존 통합코드 41590은 더 이상 실거래 조회에 안 잡힘)
  경기도 수원시 장안구  = 41111
  경기도 수원시 권선구  = 41113
  경기도 수원시 팔달구  = 41115
  경기도 수원시 영통구  = 41117
  ...
  주의: TARGET_KEYWORDS는 지역 구분 없이 전역으로 적용되는 필터라
  평택시 외 지역을 수집할 때는 실제로 원하는 단지명으로 바꾸거나
  빈 리스트로 비워 전체 수집하는 것을 권장. (지역별로 다른 키워드를
  쓰고 싶다면 pages/rtms_fetch.py의 REGION_KEYWORDS를 대신 사용)
